    ...
    return (
        <div id="header" className={`fixed flex flex-row justify-between bg-primary items-center w-full min-h-[16] pl-3 pr-7 z-[100]  ${headerClass}`} style={{ borderBottom: '3px solid rgb(255,255,255)'}}>
            ...
            <div className="font-circ-std flex flex-col md6:flex-row items-center justify-center md6:gap-6 gap-2 my-4 px-0">
                ...
                <a href="https://www.medicoinreport.org/methods" className="text-[rgb(250,250,250)] hover:text-primary-gray flex-none text-lg fade-in-out-basic">Methods</a>
                <a href="https://www.medicoinreport.org/download" className="text-[rgb(250,250,250)] hover:text-primary-gray flex-none text-lg fade-in-out-basic">Download</a>
                <a href="https://www.medicoinreport.org/data" className="text-center text-[rgb(250,250,250)] hover:bg-primary-red_light bg-primary-red px-2 pt-2 pb-1.5 rounded-xl text-lg fade-in-out-basic">View Data & Findings</a>
            </div>
        </div>
    )
}
